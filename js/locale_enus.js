 ...
 */
 texts["enus"]				= {
	...
	"importurlmsg" : "Write the address for HearthHead Deckbuilder page and click the button",
	"importhtmlmsg" : "Paste on the textarea the exported HTML text from HearthHead and click the button",
	"savedeckmsg" : "Write the name for the deck and click the button",
	"deckname" : "Deck Name",
	"givedeckname" : "Please, give a name for the deck",
